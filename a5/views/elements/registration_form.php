...
<label for="password2">Password Again: <?=REQFIELD?></label>
<input type="password" class="txt" id="password2" name="password2" value="<?php echo $password2;?>" maxlength="100" required="password2" />

<br />

<input type="hidden" name="uID" value="<?php echo $uID ?>"/>

<input type="hidden" name="active" value="<?php $active = 0 ?>"/>
